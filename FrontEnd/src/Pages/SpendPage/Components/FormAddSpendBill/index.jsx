...
function FormAddSpendBill({dataHouse,onCloseDiagram,dataApi = {},status,reLoad}) {
    console.log(dataApi);
    ...
    const handleSubmitForm = async (value) => {
        ...
        try {
            ...
            {
                value.id = dataApi.id;
                data = await normalApi.updateSpendBill(value);
            }
            else{
                data = await normalApi.addSpendBill(value);
            }
            reLoad(x => ({...x}))
            onCloseDiagram()
        ...
        <div className='formAddJob-container'>
            <div className='formAddJob-content'>
                ...
                <form onSubmit={form.handleSubmit(handleSubmitForm)}>
                    ...
                    <div className='input'>
                        <DateField name="time" label="Ngày chi" form={form}/>
                    </div>
                    <div className='input'>
                        <InputField name='price' label="Số tiền" form={form} />
                    </div>
                    <div className='input'>
                        <InputField name='receiver' label="Người nhận tiền" form={form} />
                    </div>
                    <div className='input'>
...
export default FormAddSpendBill;